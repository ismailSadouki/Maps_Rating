            ...
            <div class="bg-white shadow-lg rounded p-4 h-52">
                ...
                @auth
                    <a href="{{ route('bookmark', $place->id) }}" class="border border-teal-500 text-xs text-teal-500 hover:bg-teal-500 hover:text-gray-100 rounded ml-3 p-1">
                        <span style="color: green" class=""><i class="fa {{ Auth::user()->alreadyBookmarked($place->id) ? 'fa-bookmark' : 'fa-bookmark-o' }} fa-lg"></i></span> علامة مرجعية 
                    </a>
            ...
            <div  id="review-div" class="bg-white col-span-2 shadow-lg rounded p-5">
                ...
                <form class="form-contact" action="{{ route('review.store') }}" method="post">
                    ...
                    <div class="mt-4">
                        ...
                        <button type="submit" @error('review')  autofocus  @enderror class="mt-3 bg-blue-600 text-gray-200 rounded hover:bg-blue-500 px-4 py-2 focus:outline-none">إرسال</button>
                    </div>
                </form>
            </div>
        </div>
